          ...
          <form ref={form} action="" onSubmit={handleSubmit} >
            ...
            <Grid container justifyContent='center' > 
              ...
              <Grid item xs={8} padding={1}>
                <FormControl>
                  <FormLabel color='secondary' id="gender">Género</FormLabel>
                  <RadioGroup 
                    row 
                  ...
                  >
                    {valueRadioButtons.map(value => ( 
                      <FormControlLabel name='genero' key={value} value={value} control={<Radio color='secondary' size="small" />} label={value} />
                    ))}
                  </RadioGroup>
                </FormControl>
              </Grid>
              ...
              <Grid item>
                <FormControl >
                  <InputLabel color='secondary' htmlFor="region">Región</InputLabel>
                  <NativeSelect
                    onChange={handleChangeInputs}
                    onBlur={handleOnBlur}
